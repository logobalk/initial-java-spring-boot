 ...
 */
@Entity
@Table(name = "po_status", schema = "bpi" )
public class PoStatus implements java.io.Serializable {
	...
	public PoStatus(Integer id, String type, String code, String name, Boolean isDeleted, String createdBy,
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "poStatus")
